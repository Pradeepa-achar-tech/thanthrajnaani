...
const en = {
  appTitle: 'Temple Seva Desktop App Tutorial',
  heroEyebrow: 'Electron + React + local PostgreSQL, Coastal Karnataka-flavoured',
  heroTitlePrefix: 'Build a Temple Seva Management Desktop App by',
  heroDescription:
    'Track every topic, project, and quiz across the full 10-module curriculum — from JavaScript and Electron setup to a real offline desktop app with a local PostgreSQL database, secure IPC, seva ticketing, receipt printing, bookings, daily reports, and a Windows installer with a keep-or-delete-data uninstall prompt.',
  ...
  loginTitle: 'Temple Seva Desktop App Tutorial',
  loginSubtitle:
    'Sign in with Google to save your topics, notes, and quiz results across devices — an offline temple seva counter, built with Electron + React + PostgreSQL.',
  ...
  heroH1Highlight: 'Temple Seva',
  heroH1Suffix: 'desktop app',
  heroLead:
    'A structured, hands-on curriculum that walks you from JavaScript basics to a production Electron + React desktop app with a local PostgreSQL database, secure IPC, seva ticketing, receipt printing, and a Windows installer.',
  heroLeadStrong: 'No paywalls. Ever.',
  badgeFreeLine1: 'COMPLETELY',
  badgeFreeLine2: 'FREE',
  badgeFreeLine3: 'COURSE',
  featTopicsTitle: 'Topics',
  featTopicsBody: 'JavaScript setup to a packaged installer — structured step-by-step.',
  featCurriculumTitle: 'Real-app Curriculum',
  featCurriculumBody: 'Electron, React + Vite, local PostgreSQL, secure IPC, printing & packaging.',
  featQuizzesTitle: 'Quizzes & Projects',
  featQuizzesBody: 'Test understanding with real temple seva & booking challenges.',
