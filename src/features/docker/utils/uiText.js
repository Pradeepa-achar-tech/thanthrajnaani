...
const en = {
  appTitle: 'Docker for MERN Developers',
  heroEyebrow: 'Docker, taught the easiest way possible — one real MERN app at a time',
  heroTitlePrefix: 'Learn Docker completely, by',
  heroDescription:
    'Track every topic, project, and quiz across the full 10-module curriculum — from "what even is a container" to images, volumes, networking, multi-stage builds, Docker Compose, and shipping to production. Every concept lands inside one real running example: Kundapura Notice Board, a MERN (MongoDB, Express, React, Node) community noticeboard you containerize piece by piece.',
  ...
  loginTitle: 'Docker for MERN Developers',
  loginSubtitle:
    'Sign in with Google to save your topics, notes, and quiz results across devices — and learn Docker the easiest way, by containerizing one real MERN app.',
  ...
  heroPill: 'Practical · Hands-on · One real project',
  heroH1Prefix: 'Go from zero to',
  heroH1Highlight: 'Docker in production',
  heroH1Suffix: 'the easiest way there is',
  heroLead:
    'A practical, no-jargon curriculum that explains every Docker concept with a coastal-Karnataka analogy first, then proves it on real code: a MERN community noticeboard app you containerize, network, compose, and deploy module by module.',
  heroLeadStrong: 'No paywalls. Ever.',
  badgeFreeLine1: 'COMPLETELY',
  badgeFreeLine2: 'FREE',
  badgeFreeLine3: 'COURSE',
  featTopicsTitle: 'Topics',
  featTopicsBody: 'Containers to production deploys — structured step-by-step.',
  featCurriculumTitle: 'Build-as-you-learn',
  featCurriculumBody: 'Dockerfiles, volumes, networks, multi-stage builds, and Docker Compose.',
  featQuizzesTitle: 'Quizzes & Projects',
  featQuizzesBody: 'Test understanding by containerizing one real MERN app end to end.',
