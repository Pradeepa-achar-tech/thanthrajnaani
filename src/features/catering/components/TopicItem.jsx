      ...
      {open && hasTutorial && (
        <div className="pl-9 pr-3 pb-5 -mt-1 animate-slide-down">
          <div className="space-y-5">
            ...
            {content.diagram && (
              <div className="border-l-2 border-accent-500/30 pl-4">
                <div className="flex items-center gap-1.5 mb-2 text-[11px] uppercase tracking-wider text-accent-400 font-semibold">
