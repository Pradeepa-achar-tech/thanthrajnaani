...
const en = {
  appTitle: 'GenAI Fast-Track Tutorial',
  heroEyebrow: 'Python to a deployed LLM app — no ML degree required',
  heroTitlePrefix: 'Build a GenAI app fast, by',
  heroDescription:
    'Track every topic, project, and quiz across the full 10-module fast-track curriculum — from Python essentials and your first LLM API call to RAG with LangChain, a tool-using agent, and a deployed Streamlit app: Kundapura Sahayaka, a coastal-Karnataka GenAI assistant you build step by step.',
  ...
  loginTitle: 'GenAI Fast-Track Tutorial',
  loginSubtitle:
    'Sign in with Google to save your topics, notes, and quiz results across devices — the fast, practical path from Python to a deployed LLM app.',
  ...
  heroPill: 'Practical · Hands-on · Ship fast',
  heroH1Prefix: 'Go from zero to a',
  heroH1Highlight: 'deployed GenAI app',
  heroH1Suffix: 'in ~60 hours',
  heroLead:
    'A lean, practical curriculum that skips the deep ML theory and gets you straight to building: Python essentials, how LLMs actually work, prompting and real API calls, RAG with LangChain, an agent with tools, and a live deployed app.',
  heroLeadStrong: 'No paywalls. Ever.',
  badgeFreeLine1: 'COMPLETELY',
  badgeFreeLine2: 'FREE',
  badgeFreeLine3: 'COURSE',
  featTopicsTitle: 'Topics',
  featTopicsBody: 'Python setup to a deployed agent — structured step-by-step.',
  featCurriculumTitle: 'Ship-Fast Curriculum',
  featCurriculumBody: 'LLM APIs, LangChain, RAG, tool-calling agents, and Streamlit deployment.',
  featQuizzesTitle: 'Quizzes & Projects',
  featQuizzesBody: 'Test understanding by building one real app end to end.',
