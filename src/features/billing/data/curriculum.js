// Build a Restaurant Billing App (POS) — curriculum.
// A 10-module course that builds the TunMani Cafe Billing Flutter + Firebase app
// from scratch, taught the coastal-Karnataka way. Each module lives in its own
...
export const curriculum = {
  title: 'Build a Restaurant Billing App by Thanthrajnaani',
  subtitle: 'A real Flutter + Firebase POS system, taught the coastal Karnataka way',
