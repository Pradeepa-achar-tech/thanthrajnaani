...
const en = {
  appTitle: 'KaavalID Authentication Tutorial',
  heroEyebrow: 'ASP.NET Core + PostgreSQL, Coastal Karnataka-flavoured',
  heroTitlePrefix: 'Build KaavalID: Authentication & SSO from Scratch by',
  heroDescription:
    'Track every topic, project, and quiz across the full 10-module curriculum — from password hashing and JWTs to a production ASP.NET Core identity service with OAuth 2.0, your own OpenID Connect server, Google & Microsoft SSO, MFA, and Clerk/Auth.js token validation.',
  ...
  loginTitle: 'KaavalID Authentication Tutorial',
  loginSubtitle:
    'Sign in with Google to save your topics, notes, and quiz results across devices — a production identity & SSO service, built in C# and ASP.NET Core.',
  ...
  heroPill: 'Structured · Hands-on · Production-grade',
  heroH1Prefix: 'Build a real',
  heroH1Highlight: 'Authentication & SSO',
  heroH1Suffix: 'platform',
  heroLead:
    'A structured, hands-on curriculum that walks you from password hashing to a production ASP.NET Core identity service — JWTs, OAuth 2.0 & OpenID Connect, your own auth server, Google & Microsoft sign-in, MFA, and validating hosted providers like Clerk and Auth.js.',
  heroLeadStrong: 'No paywalls. Ever.',
  badgeFreeLine1: 'COMPLETELY',
  badgeFreeLine2: 'FREE',
  badgeFreeLine3: 'COURSE',
  featTopicsTitle: 'Topics',
  featTopicsBody: 'Password hashing to production key rotation — structured step-by-step.',
  featCurriculumTitle: 'Real-app Curriculum',
  featCurriculumBody: 'JWTs, OAuth2/OIDC, OpenIddict, Google & Microsoft SSO, MFA & Clerk/Auth.js.',
  featQuizzesTitle: 'Quizzes & Projects',
  featQuizzesBody: 'Test understanding with real identity-service build challenges.',
