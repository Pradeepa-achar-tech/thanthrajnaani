...
const en = {
  ...
  loginTitle: 'LocalInsta Tutorial',
  loginSubtitle:
    'Sign in with Google to save your topics, notes, and quiz results across devices — no card, no paywall, just neer dosa for your Flutter codebase.',
  ...
  heroH1Highlight: 'Instagram-style',
  heroH1Suffix: 'photo-sharing app',
  heroLead:
    "A structured, hands-on curriculum that walks you from Flutter setup to a production social app — feed, stories, likes, follows, realtime chat — on Supabase's free tier, no credit card anywhere in the stack.",
  heroLeadStrong: 'No paywalls. Ever.',
  badgeFreeLine1: 'COMPLETELY',
  badgeFreeLine2: 'FREE',
  badgeFreeLine3: 'COURSE',
  featTopicsTitle: 'Topics',
  featTopicsBody: 'Flutter setup to realtime chat — structured step-by-step.',
  featCurriculumTitle: 'Real-app Curriculum',
  featCurriculumBody: 'Auth, Postgres + RLS, Storage, realtime feed, stories & DMs.',
  featQuizzesTitle: 'Quizzes & Projects',
  featQuizzesBody: 'Test understanding with real social-app challenges.',
