// Module 10 — Polish, Performance & Deployment (Capstone)
  ...
  child: IconButton(
    ...
    onPressed: showOptionsMenu,
          ...
          pitfalls: [
            ...
            '**Only checking contrast for the light theme, forgetting the dark theme entirely.** Fix: check both, since Module 10\'s dark-mode work (this section\'s first topic) means both are genuinely live, user-facing themes now.',
    ...
    steps:
      - name: Ping Supabase REST endpoint
        ...
        },
        {
          ...
          whyItMatters:
            'This is the single most important verification step before considering LocalInsta genuinely done — a beautiful UI and working features mean nothing if the underlying data is not actually secured the way eleven modules of careful RLS design intended.',
          steps: [
...
# finishing LocalInsta as a complete, working, side-loadable app.`,
          pitfalls: [
            ...
            '**Building an APK when the Play Store specifically wants an AAB, or vice versa.** Side-loading needs an APK (Module 10\'s previous topic); Play Store upload needs an AAB. Fix: use the right build command for the right destination.',
          ],
          tryIt:
...
failed, not just assuming the policy text was correct."`,
          pitfalls: [
            ...
            '**Skipping this topic because the course already feels "done" after Module 10\'s deployment work.** This reflective, consolidating step is exactly what turns "I built something" into "I can confidently discuss what I built" — a genuinely different, valuable skill.',
          ],
          tryIt:
...
using (
  ...
  quiz: [
    {
      id: 'm10-q1',
      q: 'Why is wiring the dark-mode toggle in Module 10 a relatively small, low-risk change rather than a major undertaking?',
      options: [
