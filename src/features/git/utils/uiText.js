...
const en = {
  appTitle: 'Git Mastery Tutorial',
  heroEyebrow: 'Version control, end to end — no prior Git experience required',
  heroTitlePrefix: 'Master Git for real, by',
  heroDescription:
    'Track every topic, project, and quiz across the full 10-module curriculum — from your very first commit to branching, merging, rebasing, Git internals, and real GitHub team workflows. Every module builds on one running practice repository, Tide Board, as it grows from a solo project into a small team\'s shared codebase.',
  ...
  loginTitle: 'Git Mastery Tutorial',
  loginSubtitle:
    'Sign in with Google to save your topics, notes, and quiz results across devices — the complete path from your first commit to Git internals and team workflows.',
  ...
  heroPill: 'Hands-on · Command-line first · No fluff',
  heroH1Prefix: 'Go from zero to',
  heroH1Highlight: 'true Git mastery',
  heroH1Suffix: 'in ~70 hours',
  heroLead:
    'A complete, hands-on curriculum covering everything a working engineer actually needs: the daily commit/branch/merge loop, safely rewriting history, rebasing and interactive cleanup, remotes and GitHub pull-request workflows, the Git internals that make it all make sense, and the team practices (branching strategy, code review, CI, releases) real repositories run on.',
  heroLeadStrong: 'No paywalls. Ever.',
  badgeFreeLine1: 'COMPLETELY',
  badgeFreeLine2: 'FREE',
  badgeFreeLine3: 'COURSE',
  featTopicsTitle: 'Topics',
  featTopicsBody: 'First commit to Git internals — structured step-by-step.',
  featCurriculumTitle: 'Real-World Curriculum',
  featCurriculumBody: 'Branching, rebasing, GitHub PRs, internals, and team workflows.',
  featQuizzesTitle: 'Quizzes & Projects',
  featQuizzesBody: 'Test understanding on one running practice repository throughout.',
