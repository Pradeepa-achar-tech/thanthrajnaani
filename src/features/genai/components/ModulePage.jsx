...
export default function ModulePage({
  ...
  return (
    <div className="animate-fade-in">
      ...
      {/* Header */}
      <header
        className={`relative overflow-hidden rounded-2xl border border-zinc-200 bg-gradient-to-br ${module.color} p-6 md:p-7 mb-6`}
      >
        <div className="flex flex-wrap items-start justify-between gap-3 mb-2">
          <div>
            ...
            <p className="text-zinc-500 mt-2 max-w-3xl">{moduleCopy.description}</p>
          </div>
          <span className="badge bg-zinc-50 text-zinc-800 border border-zinc-200">
      ...
      {/* Tabs */}
      <div className="flex flex-wrap gap-1 mb-5 border-b border-zinc-200">
          ...
          return (
            <button
              ...
              className={`flex items-center gap-1.5 px-4 py-2.5 text-sm font-medium transition-colors border-b-2 -mb-px ${
                active
                  ? 'border-accent-500 text-zinc-900'
            ...
            >
              ...
              {id === 'quiz' && quizResult && (
                <span className="ml-1 text-[11px] px-1.5 py-0.5 rounded bg-accent-50 text-accent-700">
            ...
            return (
              <section key={section.id} className="card">
                <button
                  ...
                  className="w-full flex items-center justify-between gap-3 px-4 py-3 hover:bg-zinc-50 transition-colors rounded-xl"
                >
      ...
      {tab === 'notes' && (
        <div className="card p-5 animate-fade-in">
          ...
          <textarea
            ...
            className="w-full min-h-[260px] bg-white border border-zinc-200 focus:border-accent-500 outline-none rounded-lg p-3 text-sm text-zinc-900 placeholder-zinc-400 resize-y transition-colors"
          />
